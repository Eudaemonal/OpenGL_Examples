...
int main( void )
{
    ...
    // Load the texture
    GLuint DiffuseTexture = loadBMP_custom("PebblesBeach_DIFF.bmp");
    GLuint NormalTexture = loadBMP_custom("PebblesBeach_NORM.bmp");
    GLuint SpecularTexture = loadBMP_custom("PebblesBeach_REFL.bmp");
